...
| 수정 날짜 | 문서 경로 | 커밋 메시지 |
| :--- | :--- | :--- |
| 2026-05-14 09:05 | [Language/Python/Offline_Installation_Guide.md](Language/Python/Offline_Installation_Guide.md) | docs: CentOS 7 OpenSSL 대응 가이드를 보안상 안전한 3.0(LTS) 버전으로 업데이트 |
