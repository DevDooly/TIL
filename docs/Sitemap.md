...
* [트러블슈팅과 기술 검증 기록](Troubleshooting/README.md)
    * [FTP 처리와 Virtual Thread](Language/Java/Virtual_Threads_FTP_Pinning.md)
    * [Kubernetes의 Virtual Thread](Language/Java/Virtual_Threads_in_K8s.md)
    * [Kafka Consumer pinning](Language/Java/SpringBoot/Virtual_Thread_Pinning_Kafka.md)
    * [JDBI 실행기 격리](Language/Java/SpringBoot/JDBI_VT_Pinning_Solution.md)
    * [JDBI FetchSize](Data/Database/JDBI_FetchSize_and_VirtualThreads.md)
    * [연결된 GZIP 해제](Language/Java/Concatenated_Gzip_Decompression.md)
    * [K8s Spring 프로파일](Language/Java/SpringBoot/Spring_Profile_Priority_in_K8s.md)
    * [로깅 YAML/XML 전환](Language/Java/SpringBoot/Logging_Config_Migration_YAML_to_XML.md)
    * [SLF4J key-value와 ECS](Language/Java/SpringBoot/Logging_ECS_KeyValue_Support.md)
    * [RoundRobin 불균형](Infrastructure/MessageBroker/Kafka/Producer_Partitioner_Issue.md)
    * [파티셔너 변화](Infrastructure/MessageBroker/Kafka/Partitioner_Evolution_and_Imbalance.md)
    * [abortOnNewBatch](Infrastructure/MessageBroker/Kafka/AbortOnNewBatch_Issue.md)
    * [Consumer 종료](Infrastructure/MessageBroker/Kafka/Consumer_Safe_Shutdown.md)
...
* [☕ Language & Runtime Ecosystem](Language/README.md)
    * **Java**
        ...
        * [Java: 연결된 GZIP 멤버 압축 해제](Language/Java/Concatenated_Gzip_Decompression.md)
        ...
        * **SpringBoot**
            ...
            * [JDBI와 Virtual Thread: 진단 후 제한된 실행기로 격리하기](Language/Java/SpringBoot/JDBI_VT_Pinning_Solution.md)
            ...
            * [Kafka Consumer와 Virtual Thread: Pinning 진단 범위](Language/Java/SpringBoot/Virtual_Thread_Pinning_Kafka.md)
            * **JPA**
...
* [LLM을 활용한 레거시 코드 개선과 검증 기록](LLM_Development/Legacy_Code_Improvement.md)
